...
cmd_ban = rate_limit(meta.cmd_ban, name="ban")
cmd_unban = rate_limit(meta.cmd_unban, name="unban")
cmd_banlist = rate_limit(meta.cmd_banlist, name="banlist")
...
cmd_cfmodels = rate_limit(ai.cmd_cfmodels, name="cfmodels")
cmd_cfvoice = rate_limit(ai.cmd_cfvoice, name="cfvoice")
...
cmd_protondb = rate_limit(media.cmd_protondb, name="protondb")
