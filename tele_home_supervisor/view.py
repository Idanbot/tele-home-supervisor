...
# Re-export chart functions so existing ``view.render_*_chart`` calls keep
# working without touching every call-site.  New code should import from
# ``charts`` directly.
from .charts import (  # noqa: F401
    render_alerts_chart,
    render_audit_chart,
    render_docker_stats_chart,
    render_health_chart,
    render_metrics_chart,
    render_speedtest_chart,
    render_torrent_chart,
    render_traceroute_chart,
)
